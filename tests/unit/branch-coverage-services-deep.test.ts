  ...
  describe('duplicateBrandProfile', () => {
    ...
    it('should duplicate with all fields null (falsy || undefined branches)', async () => {
      const sourceRow = {
        ...
        color_palette: null, typography_logo: null, typography_heading: null, typography_body: null,
    ...
    it('should duplicate with populated fields (truthy branches)', async () => {
      const sourceRow = {
        ...
        typography_logo: 'Inter', typography_heading: 'Inter', typography_body: 'Open Sans',
